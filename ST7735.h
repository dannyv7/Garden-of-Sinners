...
//
void DrawBgScroll(void);
void DrawBg(void);
void DrawVirtualBg(void);
void ST7735_DrawBitmapClear(int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h, int32_t BGheight);
void DrawSprite(int16_t x, int16_t y, const uint16_t *image, int16_t w, int16_t h, int32_t BGheight);
#endif
